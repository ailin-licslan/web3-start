...
//
//             console.log("Fetched wallet balance:", walletBal);
//             console.log("Fetched bank balance:", bankBal);
//             console.log("Fetched token symbol:", symbol);
//             console.log("Fetched allowance:", allowanceBal);
//         } catch (err) {
