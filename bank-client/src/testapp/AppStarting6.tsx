...
//
// // Define supported chains for the contract (only Hardhat for now)
// const SUPPORTED_CHAINS = [31337];
//
...
//             });
//
//             web3Instance.eth.getChainId().then(setChainId).catch(err => {
//                 setError('无法获取链 ID: ' + err.message);
//             });
//         } else {
...
//         try {
//             const currentChainId = parseInt(chainId || '0', 16);
//             if (!chainId || !SUPPORTED_CHAINS.includes(currentChainId)) {
//                 setError('当前链不支持此合约，请切换到 Hardhat 本地网络');
//                 setWalletBalance(null);
//                 setBankBalance(null);
//                 setTokenSymbol(null);
//                 setAllowance(null);
...
//             const tokenCode = await web3Instance.eth.getCode(TOKEN_ADDRESS);
//             const bankCode = await web3Instance.eth.getCode(BANK_ADDRESS);
//             if (tokenCode === '0x' || bankCode === '0x') {
//                 setError('合约未部署在指定地址，请检查 Hardhat 部署状态');
//                 setWalletBalance(null);
//                 setBankBalance(null);
//                 setTokenSymbol(null);
//                 setAllowance(null);
...
//             console.log("Allowance fetched:", allowanceBal);
//
...
//                                     if (CHAINS[parseInt(selectedChainId)]) {
//                                         switchChain(CHAINS[parseInt(selectedChainId)].chainId);
//                                     }
//                                 }}
//                                 value={chainId ? Object.keys(CHAINS).find(key => CHAINS[parseInt(key)].chainId === chainId) || '' : ''}
...
//                             >
//                                 <option value="" disabled>选择链</option>
